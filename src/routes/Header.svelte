...
<Navbar class="px-4 sm:px-4 py-2.5 fixed w-full z-20 top-0 start-0 border-b pt-0 pb-0">
	<NavBrand href="/">
		...
		<span class="self-center whitespace-nowrap text-xl font-semibold dark:text-white">Siasat</span>
	</NavBrand>
	<NavHamburger />
	<NavUl {activeUrl}>
		<NavLi href="/">Home</NavLi>
		<NavLi class="cursor-pointer">
			Dashboard<ChevronDownOutline class="w-3 h-3 ms-2 text-primary-800 dark:text-white inline" />
		</NavLi>
		<Dropdown class="w-44 z-20">
			<DropdownItem href="/dashboard">Dashboard V1</DropdownItem>
			<DropdownItem href="/dashboard2">Dashboard V2</DropdownItem>
		</Dropdown>
		<NavLi class="cursor-pointer">
